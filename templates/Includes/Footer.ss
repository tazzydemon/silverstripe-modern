<footer role="contentinfo">
    <div class="container">
        ...
        <p class="text-center">&copy; Copyright {$Now.Year} {$SiteConfig.Title}. All rights reserved. | Modern SilverStripe theme by <a href="http://www.ilateralweb.co.uk" target="_blank">ilateral</a>.</p>
    </div>
</footer>